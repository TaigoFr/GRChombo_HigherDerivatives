...
#ifndef SCHBHLEVEL_HPP_
#define SCHBHLEVEL_HPP_

#include "DefaultLevelFactory.hpp"
#include "GRAMRLevel.hpp"

class GeometryTestsLevel : public GRAMRLevel
{
    friend class DefaultLevelFactory<GeometryTestsLevel>;
