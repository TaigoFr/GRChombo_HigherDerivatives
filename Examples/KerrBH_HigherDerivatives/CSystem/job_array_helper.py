...
# Run as: 'python job_array_helper.py index total', where index is the index in the array, of a total of 'total' jobs
...
if len(sys.argv)>2:
    ...
    print("Run as 'python job_array_helper.py index total'")