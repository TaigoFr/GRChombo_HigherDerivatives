...
#if !defined(OLDCCZ4_HPP_)
#error "This file should only be included through OldCCZ4.hpp"
#endif

#ifndef OLDCCZ4_IMPL_HPP_
#define OLDCCZ4_IMPL_HPP_
...
inline OldCCZ4::OldCCZ4(params_t params, double dx, double sigma,
                        int formulation, double cosmological_constant)
...
template <class data_t> void OldCCZ4::compute(Cell<data_t> current_cell) const
{
...
void OldCCZ4::rhs_equation(vars_t<data_t> &rhs, const vars_t<data_t> &vars,
